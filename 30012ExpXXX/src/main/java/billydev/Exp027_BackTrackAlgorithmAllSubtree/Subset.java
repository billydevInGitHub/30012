package billydev.Exp027_BackTrackAlgorithmAllSubtree;
...
private static int[] x = new int[n];  //Billy: this is the output filter set array !! 

private static int count=0; //Billy Add it; 
