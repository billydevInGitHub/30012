package billydev.Exp018_BloomFilter;

import java.util.BitSet;

public class BloomFilter {
	//refer to:  https://www.javamex.com/tutorials/collections/bloom_filter_java.shtml
	
	private static final int MAX_HASHES = 8;
	
	/**
	 * The following should be hashcode implementation
	 * 
	 */
	  ...
	  /**
	   * 
	   * the following is constructor and 
	   */
	  ...
	  /**
	   * The following is add and constructor methods
	   * 
	   */
	  public void add(String s) {
		  ...
		  public static void main(String[] args){
			  BloomFilter bf= new BloomFilter(16,8);
			  bf.add("test");
